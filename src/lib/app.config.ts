...
export default class App {
    ...
    public static readonly Env = class {
        ...
        public static readonly baseUrl = App.Env.isDev ? 'http://localhost:3000' : process.env.NEXT_PUBLIC_BASE_URL!;
        // Add more environment variables here.
    }

    public static readonly Meta = class {
        public static readonly lang = process.env.NEXT_PUBLIC_LANG ? process.env.NEXT_PUBLIC_LANG : 'en';
